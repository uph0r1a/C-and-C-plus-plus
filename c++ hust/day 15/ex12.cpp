...
int main(int argc, char const *argv[])
{
    ...
    stringTable[0] = "banana";
    stringTable[1] = "apple";
    stringTable[2] = "orange";
    stringTable[3] = "grape";
    stringTable[4] = "peach";
    stringTable[5] = "cherry";
    stringTable[6] = "mango";
    stringTable[7] = "lemon";
    stringTable[8] = "kiwi";
    stringTable[9] = "plum";
    ...
    cout << "\nSearching for \"mango\" in stringTable.\n";
    result = stringTable.findItem("mango");
    if (result == -1)
        cout << "mango was not found.\n";
    else
        cout << "mango found at index " << result << endl;
